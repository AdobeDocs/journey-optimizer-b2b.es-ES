...
description: 'Diseñe correos electrónicos, páginas de aterrizaje y fragmentos con componentes de contenido: añada botones, texto, imágenes, formularios y contenedores en Journey Optimizer B2B Prime.'
...
Puede agregar tantos componentes de contenido como necesite dentro de uno o más [componentes de estructura](./structure-components.md) que definen el diseño.
...
![Barra de herramientas de componentes de contenido](../../user/assets/do-not-localize/toolbar-content.png){width="450"}
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-text-styles.png" alt="Cambiar herramienta de estilo de texto"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-horizontal-alignment.png" alt="Herramienta Alineación horizontal"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-create-list.png" alt="Herramienta Crear lista"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-set-heading.png" alt="Herramienta Definir encabezado"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-font-size.png" alt="Herramienta Tamaño de fuente"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-font-color.png" alt="Herramienta Color de fuente"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-insert-link.png" alt="Herramienta Insertar vínculo"></td>
...
<table>
    ...
    <tr>
        <td><img width="80px" src="../../user/assets/do-not-localize/toolbar-button-remove-link.png" alt="Quitar herramienta de vinculación"></td>
...
| ---- | ---- | ----- |
| ![Adición de personalización](../../user/assets/do-not-localize/toolbar-button-add-personalization.png){width="40"} | Añadir personalización | Utilice el editor de personalización para insertar tokens de personalización en el contenido del componente. [Más información](./email-authoring.md#personalize-content) |
| ![Mostrar el código fuente](../../user/assets/do-not-localize/toolbar-button-show-source-code.png){width="40"} | Mostrar el código fuente | Muestre el código fuente de HTML del componente en una ventana emergente de solo lectura. <br/>![Mostrar código HTML](../../user/content/assets/content-components-show-source-code.png){width="200"} |
| ![Habilitar contenido condicional](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Habilitar contenido condicional | (Correos electrónicos y fragmentos) Habilite variantes condicionales para el componente. |
| ![Duplicar](../../user/assets/do-not-localize/toolbar-button-duplicate.png){width="40"} | Duplicado | Cree una copia del componente y agréguelo directamente debajo. |
| ![Eliminar](../../user/assets/do-not-localize/toolbar-button-delete.png){width="40"} | Eliminar | Desmonte el componente. |
...
1. En la biblioteca **[!UICONTROL Componentes]**, agarre el _controlador de arrastre_ ![controlador de arrastre](../../assets/do-not-localize/icon-drag-handle.svg) para el componente de contenido de su elección y arrástrelo y suéltelo en los componentes de la estructura.
   ...
   ![Arrastre el componente de contenido al componente de estructura](../../user/content/assets/content-components-drag.png){width="600" zoomable="yes"}
...
1. Ajuste la visualización del componente mediante las pestañas **[!UICONTROL Settings]** y **[!UICONTROL Styles]** de la derecha o la barra de herramientas contextual que se muestra en el lienzo.
   ...
   ![Defina la configuración y los estilos para el componente de contenido](../../user/content/assets/content-components-settings-styles.png){width="600" zoomable="yes"}
...
![Opciones de visualización para el componente de contenido](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Estilos de componente de contenido de contenedor](../../user/content/assets/content-components-container.png){width="600" zoomable="yes"}
...
![Componente de botón mostrado con la barra de herramientas](../../user/content/assets/content-components-button.png){width="500" zoomable="yes"}
...
1. Establezca **[!UICONTROL Type]** para el vínculo:
   ...
   * **[!UICONTROL Vínculo externo]**: elija este tipo para usar una dirección URL estándar como destino del vínculo.
     ...
     En **[!UICONTROL URL]**, escriba la dirección URL del destino del vínculo. Haga clic en el icono _Personalizar_ ( ![Icono Personalizar](../../user/assets/do-not-localize/icon-personalize.svg) ) para usar un token de personalización como parámetro en la dirección URL.

     ![Definir un vínculo externo para un componente de botón](../../user/content/assets/component-button-link-options-external.png){width="200"}
   ...
   * **Página de aterrizaje**: elija este tipo para seleccionar una página de aterrizaje publicada en <!-- Journey Optimizer B2B Edition (_Beta_) or -->la instancia de Marketo Engage conectada.
     ...
     Para la opción **[!UICONTROL Página de aterrizaje]**, seleccione la página de aterrizaje publicada. Haga clic en el icono _Seleccionar página_ ( ![Mostrar icono de vínculos](../../user/assets/do-not-localize/icon-landing-page-select.svg) ) y [seleccione la página de aterrizaje publicada](./landing-pages.md#link-to-landing-page).

     ![Definir un vínculo a una página de aterrizaje para un componente de botón](../../user/content/assets/component-button-link-options-landing-page.png){width="200"}
...
1. Seleccione el componente en el lienzo y haga clic en el icono _Mostrar código fuente_ de la barra de herramientas.
   ...
   ![Abra el editor de código para agregar el HTML](../../user/content/assets/content-components-html-show-code.png){width="450"}

1. Pegue el HTML en el cuadro de texto y haga clic en **[!UICONTROL Guardar]**.

   ![Cuadro de diálogo Editar HTML](../../user/content/assets/content-components-html-edit-dialog.png){width="600" zoomable="yes"}
...
![Componente de imagen mostrado con la barra de herramientas](../../user/content/assets/content-components-image.png){width="400" zoomable="yes"}
...
* **[!UICONTROL Seleccionar recurso]**: elija este tipo para examinar y seleccionar un recurso de imagen de la biblioteca de Assets [!DNL Journey Optimizer B2B Prime].
  ...
  ![Examinar los recursos de imagen disponibles](./assets/dam-assets-internal-image-selected.png){width="700" zoomable="yes"}
...
* **[!UICONTROL Importar medios]**: elija este tipo para seleccionar un archivo de su sistema e importarlo a la biblioteca de recursos [!DNL Journey Optimizer B2B Prime].
  ...
  ![Importar un archivo de imagen a la biblioteca de recursos](../../user/content/assets/email-designer-image-upload.png){width="450"}
...
![Configuración de imagen](./assets/dam-assets-image-settings.png){width="250"}
...
1. Establezca **[!UICONTROL Type]** para el vínculo:
   ...
   * **[!UICONTROL Vínculo externo]**: elija este tipo para usar una dirección URL estándar como destino del vínculo.
     ...
     ![Definir un vínculo externo para un componente de imagen](../../user/content/assets/component-button-link-options-external.png){width="250"}

   * **Página de aterrizaje**: elija este tipo para seleccionar una página de aterrizaje publicada en <!-- Journey Optimizer B2B Edition (_Beta_) or -->la instancia de Marketo Engage conectada.

     Para la opción **[!UICONTROL Página de aterrizaje]**, seleccione la página de aterrizaje publicada. Haga clic en el icono _Seleccionar página_ ( ![Mostrar icono de vínculos](../../user/assets/do-not-localize/icon-landing-page-select.svg) ) y [seleccione la página de aterrizaje publicada](./landing-pages.md#link-to-landing-page).

     ![Definir un vínculo a una página de aterrizaje para un componente de imagen](../../user/content/assets/component-button-link-options-landing-page.png){width="250"}
...
![Configuración del tipo de medios sociales expandidos](./assets/content-components-social-settings-for-type.png){width="250"}
