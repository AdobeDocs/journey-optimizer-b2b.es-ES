...
description: Utilice componentes de estructura para correos electrónicos, páginas de aterrizaje y diseños de fragmento. Arrastre columnas, establezca estilos y configure la visualización móvil en Journey Optimizer B2B Prime.
...
![Barra de herramientas de componentes de estructura](../../user/assets/do-not-localize/toolbar-structure.png){width="150"}
...
| ![Seleccionar columna](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | Seleccionar una columna | Seleccione una columna por número. Cuando se selecciona la columna, puede aplicar la configuración de columna y los estilos. |
...
![Opciones de visualización para el componente de estructura](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Componente de estructura establecido como encabezado](../../user/content/assets/structure-component-settings-header.png){width="600" zoomable="yes"}
...
![No apilar columnas en dispositivos móviles](../../user/content/assets/structure-component-settings-stack-columns.png){width="250"}
...
![Configuración de imagen de fondo del componente de estructura con selector de recursos](../../user/content/assets/structure-components-background-image-settings.png){width="250"}

Haga clic en **[!UICONTROL Seleccionar recurso]** para abrir el selector de recursos, donde podrá elegir una imagen de la [biblioteca de Assets](./digital-asset-management.md#assets-authoring).
...
![Vista previa de ubicación de imagen de fondo en un componente de estructura](../../user/content/assets/structure-component-styles-background-image.png){width="250"}

### Otros estilos {#other-styles}

Puede aplicar otros estilos de componente de estructura para ajustar su visualización en el mensaje de correo electrónico o en la página de aterrizaje. Para aplicar estilo más allá de estas opciones integradas, consulte [Agregar CSS personalizado para el contenido](./design-custom-css.md).
...
![Barra de herramientas de columnas](../../user/assets/do-not-localize/toolbar-column.png){width="500"}

| Herramienta | Nombre | Uso |
| ---- | ---- | ----- |
| — | Borrar columna | Borre el contenido de la columna. Consulte la primera herramienta en la figura de la barra de herramientas de la columna. |
| ![Habilitar contenido condicional](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Habilitar contenido condicional | (Correos electrónicos y fragmentos) Habilite variantes condicionales para la columna. |
| ![Seleccionar una columna](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | Seleccionar una columna | Seleccione una columna por número. Cuando se selecciona la columna, puede aplicar ajustes y estilos. |

### Cambiar n:n columnas {#change-nn-columns}

Los anchos de columna son estáticos para la mayoría de los componentes de estructura. Al agregar el componente _[!UICONTROL n:n column]_, puede cambiar el número de columnas y el tamaño de las columnas. El componente de columna n:n comienza con cinco columnas de igual ancho (20 %).
...
![Configuración de número de columnas](../../user/content/assets/structure-components-n-n-columns-number.png){width="650" zoomable="yes"}
...
![Cambiar tamaño de columna](../../user/content/assets/structure-components-n-n-columns-resize.png){width="500" zoomable="yes"}
...
* **[!UICONTROL Imagen de fondo]** - Mueva el selector de alternancia para habilitar la configuración de la imagen de fondo.
  ...
  ![Configuración de imagen de fondo de columna en el panel Estilos](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
En el espacio de diseño visual, puede acceder a los componentes estructurales, incluidas las columnas y el contenido, mediante el árbol de navegación. Haga clic en el icono _[!UICONTROL Árbol de navegación]_ ( ![Icono del árbol de navegación](../../user/assets/do-not-localize/icon-navigation-tree.svg) ) en la parte izquierda para mostrar el árbol.
