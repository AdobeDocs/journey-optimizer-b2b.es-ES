...
description: Añada CSS personalizado a correos electrónicos y páginas de aterrizaje para lograr un estilo avanzado y un control de diseño preciso que vaya más allá de los componentes estándar en Journey Optimizer B2B Prime.
...
1. Seleccione la ficha _Estilos_ a la derecha y haga clic en **[!UICONTROL Agregar CSS personalizado]**.
   ...
   ![Acceder a los estilos del cuerpo](../../user/content/assets/email-body-styles.png){width="800" zoomable="yes"}
...
1. Introduzca su código CSS en el editor.
   ...
   ![Escriba CSS personalizado en el editor](../../user/content/assets/content-design-add-custom-css.png){width="450"}
...
1. Haga clic en **[!UICONTROL Guardar]** para guardar el CSS personalizado.
   ...
   ![CSS personalizado aplicado al contenido](../../user/content/assets/email-body-custom-css-applied.png){width="600" zoomable="yes"}
