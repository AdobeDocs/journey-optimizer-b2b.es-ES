...
description: Utilice la página de inicio en Journey Optimizer B2B Prime para iniciar conversaciones sobre IA, iniciar habilidades y saltar a Marketing, Assets, Informes y Destinos.
...
La página _Home_ es tu plataforma de inicio en Adobe Journey Optimizer B2B Prime. Seleccione el icono _Inicio_ en la parte superior de la navegación izquierda para abrirlo. La página le saluda con **Bienvenido [nombre], ¿qué podemos construir hoy?** y está diseñado para llevarle de la idea a la acción en un solo clic.

![Página de inicio](./assets/home-page.png){width="800" zoomable="yes"}

## Cuadro de entrada

Una entrada de _Formular una pregunta o iniciar una tarea_ grande se encuentra en el centro de la página principal. Escriba cualquier cosa aquí para comenzar a trabajar con el panel conversacional de IA o use el icono _Adjuntar_ (**+**) para agregar un archivo (como un resumen de campaña o un CSV) antes de enviar. Se trata del mismo asistente de IA disponible durante toda la administración de marketing, pero comenzar aquí abre una nueva conversación.
...
| **Destinos** | Sistemas descendentes y sincronizaciones. |
