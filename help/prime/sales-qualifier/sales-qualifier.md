...
description: Calificador de ventas para Journey Optimizer B2B Prime ofrece calificación de clientes potenciales de IA, flujos de trabajo salientes, integración CRM, tareas y configuración de perfil para BDR.
...
El Calificador de ventas se incluye con [!DNL Journey Optimizer B2B Prime], pero se trata de una aplicación independiente dentro de Adobe Experience Platform.

![Pantalla de inicio del calificador de ventas](../../user/agents/assets/home-screen.png){width="800" zoomable="yes"}
...
![Tabla de clientes potenciales que muestra el estado del posible cliente y la última actividad para la administración de clientes potenciales](../../user/agents/assets/prospects.png){width="800" zoomable="yes"}
...
![Ficha Información general del flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-overview.png){width="800" zoomable="yes"}
...
1. Elige **[!UICONTROL Comenzar desde cero]** para escribir tu propio objetivo o **[!UICONTROL Comenzar desde la plantilla]** para usar una plantilla guardada.
   ...
   ![Crear flujo de trabajo saliente desde cero](../../user/agents/assets/outbound-workflow-create-start-from-scratch.png){width="700" zoomable="yes"}
...
1. Haga clic en la flecha hacia abajo para mostrar la lista **[!UICONTROL Agregar un filtro]** y seleccione el filtro que desee aplicar.
   ...
   ![Crear filtros de destino de flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-create-targeting-filter-list.png){width="700" zoomable="yes"}

1. Establezca valores para el filtro.

1. Añada más filtros si necesita reducir la audiencia.

   ![Crear flujo de trabajo saliente Segmentación añadió filtros con valores](../../user/agents/assets/outbound-workflow-create-targeting-filters-values.png){width="600" zoomable="yes"}
...
![Mensajes y cadencia de punto de contacto generados por flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-create-touchpoints.png){width="700" zoomable="yes"}
...
![Configuración de flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-create-settings.png){width="700" zoomable="yes"}
...
![Perspectivas de adición de flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-create-add-prospects.png){width="700" zoomable="yes"}
...
![Correos electrónicos generados por revisión de flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-create-review-generated-emails.png){width="700" zoomable="yes"}
...
![Motivo de IA de correo electrónico generado por flujo de trabajo saliente](../../user/agents/assets/outbound-workflow-create-review-generated-email-reasoning.png){width="600" zoomable="yes"}
...
1. En el editor de correo electrónico, haga clic en **[!UICONTROL Generar con IA]**.
   ...
   ![El flujo de trabajo saliente generó refinamiento de correo electrónico con IA](../../user/agents/assets/outbound-workflow-create-review-generated-email-edit-regenerate.png){width="600" zoomable="yes"}
...
![Flujo de trabajo saliente para seleccionar y aprobar clientes potenciales](../../user/agents/assets/outbound-workflow-create-approve-enroll-prospects.png){width="700" zoomable="yes"}
...
![Página de tareas que muestra la cola de tareas y el panel de detalles](../../user/agents/assets/tasks.png){width="800" zoomable="yes"}
...
1. En el panel de navegación izquierdo, expanda **[!UICONTROL Administración]** y seleccione **[!UICONTROL Integraciones]**.
   ...
   ![Página de integraciones con tarjetas de conexión de Salesforce y Dynamics](../../user/agents/assets/integrations-crm-connections.png){width="800" zoomable="yes"}
...
![Integraciones - Centro de conocimientos](../../user/agents/assets/integrations-knowledge-center.png){width="700" zoomable="yes"}
...
![Pestaña Configuración de correo electrónico que muestra las opciones de conexión de correo electrónico y la configuración de firma de correo electrónico](../../user/agents/assets/email-settings.png)
