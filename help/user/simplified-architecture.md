...
&gt; <li>Esquema de referencia: [Cuenta B2B - Esquema de cuenta empresarial de XDM](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/schemas/create-schemas-for-b2b-data)
