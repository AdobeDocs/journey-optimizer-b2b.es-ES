...
>[!NOTE]
>
>Estos cambios de versión comienzan a implementarse el 14 de agosto de 2026, con un despliegue gradual de cada función y mejora. Las fechas de lanzamiento de las funciones y mejoras están sujetas a cambios.
...
| Tipo | Elemento | Descripción |
| ---- | ---- | ----------- |
| Función | _Nodos de recorrido de_ rutas divididas de variantes - recorridos de cuenta | (Beta) Los especialistas en marketing ahora pueden probar las variaciones dentro de un recorrido asignando cuentas o personas a diferentes rutas de recorrido en función de porcentajes definidos. [Más información](../journeys/variant-split-paths-nodes.md) |
...
| Mejora | _Realizar una acción_ nodos de recorrido | Ya hay disponibles acciones adicionales para el contexto de personas del recorrido de cuenta y desde un recorrido de persona: _Agregar al recorrido de persona_ y _Quitar del recorrido de persona_. [Más información](../journeys/action-nodes.md#people-actions) |
...
>[!NOTE]
>
>Estos cambios de versión comienzan a implementarse el 22 de mayo de 2026, con un despliegue gradual de cada función y mejora. Las fechas de lanzamiento de las funciones y mejoras están sujetas a cambios.
...
| Tipo | Elemento | Descripción |
| ---- | ---- | ----------- |
| Función | Canal de WhatsApp | Los especialistas en marketing ahora pueden enviar mensajes de WhatsApp directamente desde los recorridos de la cuenta a través de [!DNL Meta Cloud API]. Esta función permite una integración perfecta de la mensajería de WhatsApp para admitir canales de contenido de recorrido. [Más información](../admin/configure-channels-whatsapp.md) |
...
| Mejora | Objetos personalizados de persona: comprar plantillas de roles de grupo | Cuando los administradores configuran objetos personalizados relacionados con un perfil de persona de negocios, los especialistas en marketing ahora pueden definir funciones de grupo de compra mediante estos objetos personalizados. [Más información](../buying-groups/buying-groups-role-templates.md#add-the-template-roles) |
...
| Mejora | (Beta) Personalización de contenido: compatibilidad con objetos personalizados de persona | Cuando los especialistas en marketing definen la personalización de contenido mediante los objetos personalizados, pueden acceder a las variables de los objetos personalizados de clase basados en modelos (esquemas relacionales). [Más información](../content/personalization.md#custom-datasets) |
...
* **Diseñado para la escalabilidad a largo plazo**: esta actualización prepara a su organización para la innovación y las mejoras continuas.

>[!NOTE]
>
>Revise la [lista de comprobación de instalación](../setup-ultimate.md) para obtener instrucciones de configuración.

En la versión 2025.10 están disponibles las siguientes nuevas funciones y mejoras con la arquitectura actualizada:
...
| Función | Panel de información general de Recorrido | En el caso de los recorridos de cuenta, la pestaña **[!UICONTROL Información general]** proporciona una instantánea completa de los recorridos activos, con gráficos de círculos y barras que categorizan y cuantifican las finalizaciones y las actividades de participación. <a href="../dashboards/journeys-dashboard.md">Más información</a> |
