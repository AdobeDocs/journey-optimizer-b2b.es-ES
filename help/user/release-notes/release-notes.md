...
Revise la [descripción del producto](https://helpx.adobe.com/legal/product-descriptions/adobe-journey-optimizer-b2b.html) para obtener información sobre los derechos, las protecciones de rendimiento y las limitaciones.

## Notas de la versión 2025.3

**Fecha de la versión**: miércoles, 01 de abril de 2025

Esta versión incorpora las siguientes nuevas capacidades y mejoras:
...
| Nueva función | Detalles grupo y cuenta de compra | Ver información en el grupo de compra y en el nivel cuenta para tener más contexto y datos históricos cuando inicio interactuar con un cliente.<p>Los detalles del grupo de compra incluyen cualquier intención de primera parte que se detecte. <a href="../buying-groups/buying-group-details.md">Más información</a><p>Las cuentas de detalles de cuenta resaltan el aumento en participación intención detectada, de modo que pueda alerta las ventas en cuentas que están listas para ventas personalizadas centradas en participación.  <a href="../accounts/account-details.md">Más información</a> |
...
| Nueva función | Edición de imágenes Adobe Systems Express | Las acciones rápidas de Adobe Express le permiten realizar ediciones sencillas (como recortar y cambiar el tamaño) en imágenes para conseguir un aspecto más pulido en el contenido. <a href="../content/image-edit-adobe-express.md#quick-actions-in-adobe-express">Más información</a>  <p>Para obtener un conjunto más completo de herramientas de diseño, esta integración permite obtener una licencia completa de Adobe Express en Journey Optimizer B2B edition. Con esta configuración, se puede acceder a la interfaz de usuario completa de Adobe Express desde el espacio de trabajo de recursos local. <a href="../content/image-edit-adobe-express.md#adobe-express-enterprise-license">Más información</a> |
...
| Mejora | Nuevas plantillas de correo electrónico listas para usar | La biblioteca de plantillas de ejemplo ahora incluye plantillas de correo electrónico adicionales diseñadas para los especialistas en marketing B2B. Utilice estas plantillas de ejemplo como punto de partida y agregue sus propios promoción de la marca y mensajería. <a href="../content/email-templates.md#select-a-design-template">Más información</a> |
| Mejora | Campos personalizados como atributos de persona | Si tiene campos personalizados de persona definidos en el esquema de audiencia de cuenta en Experience Platform, estos campos también están disponibles para su uso como atributos de persona en condiciones. Utilice estos atributos personalizados en: <li>Plantillas <a href="../buying-groups/buying-groups-role-templates.md#add-the-template-roles">de funciones Más información</a></li><li>Dividir rutas por nodos de recorrido de personas <a href="../journeys/split-merge-paths-nodes.md#add-a-split-path-by-people-node">Más información</a></li> |
| Mejora | Configuración de canal de correo electrónico | La configuración del correo electrónico ahora es visible en la interfaz de Journey Optimizer B2B Edition. Puede revisar rápidamente las configuraciones actuales y los administradores pueden hacer clic en _[!UICONTROL Editar configuración]_ para ir directamente a la configuración en Marketo Engage y actualizarla según los requisitos de su organización. <a href="../admin/configure-channels-emails.md">Más información</a> |
...
| Tipo | Elemento | Descripción |
| ---- | ---- | ----------- |
| Mejora | Central activos biblioteca | La biblioteca _de activos central mejorada_ le permite utilizar todos los activos de imágenes en su Marketo Engage instancia, en todos los espacios de trabajo de Design Studio. Hay barreras integradas que evitan las ediciones en el activos de Marketo Engage desde Journey Optimizer B2B Edition, así como las operaciones de eliminación y movimiento. Estas protecciones garantizan el mantenimiento de los activos de origen (Marketo Engage Design Studio) al tiempo que permiten una lectura y reutilización perfectas en Journey Optimizer B2B Edition.<p>Para activos que son exclusivamente para uso en Journey Optimizer B2B Edition, una espacio de trabajo específica proporciona funciones administración de recursos completas. <a href="../content/marketo-engage-design-studio.md">Más información</a> |
