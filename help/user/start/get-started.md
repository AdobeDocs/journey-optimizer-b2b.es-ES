...
description: 'Guía de incorporación para especialistas en marketing: cree grupos de compra y diseñe recorridos de cuenta en Journey Optimizer B2B edition.'
role: User
level: Beginner
...
# Guía de incorporación del usuario

Las funciones y herramientas que desea utilizar en Adobe Journey Optimizer B2B edition dependen de la función que tenga en su equipo. En función de su organización, puede definir varios tipos de usuarios y concederles acceso a determinadas funcionalidades dependiendo de sus permisos.

Una vez que un administrador complete las [tareas de instalación](../setup-ultimate.md), use esta información para la incorporación general del usuario.
...
1. **Añadir públicos de cuenta**. Journey Optimizer B2B edition le permite crear audiencias de cuenta a través de definiciones de segmentos directamente desde la aplicación y aprovecharlas en los recorridos de la cuenta. [Más información](../audiences/account-audience-overview.md)
...
1. **Creación y administración de recursos**. Adobe Experience Manager Assets proporciona un único repositorio centralizado de recursos que puede utilizar en sus mensajes. [Más información](../content/assets-overview.md)

1. **Agregar plantillas de correo electrónico personalizadas y dinámicas**. Aproveche las funcionalidades de personalización y contenido dinámico de Journey Optimizer B2B Edition para adaptar el mensaje a su público. [Más información](../content/email-templates.md)
...
1. **Diseñe recorridos de clientes para ofrecer experiencias personalizadas y contextuales**. Journey Optimizer B2B Edition le permite crear casos de uso de orquestación en tiempo real con datos contextuales almacenados en eventos o fuentes de datos. Diseñe escenarios avanzados que constan de varios pasos con las siguientes funcionalidades:
   ...
   * Envíe envíos unitarios en tiempo real que se activen cuando se reciba un evento o en lote mediante audiencias de Adobe Experience Platform.
