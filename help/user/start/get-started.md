...
Una vez que un administrador complete las [tareas de instalación](../simplified-architecture.md), use esta información para la incorporación general del usuario.
...
1. **Cree grupos de compras**. Defina los componentes clave para alcanzar sus metas y objetivos empresariales, y cree grupos de compra que identifiquen a los miembros para sus listas de cuentas objetivo. [Más información](../buying-groups/buying-groups-overview.md)
...
1. **Añada plantillas de correo electrónico personalizadas y dinámicas**. Aproveche las funcionalidades de personalización y contenido dinámico de Journey Optimizer B2B edition para adaptar el mensaje a su audiencia. [Más información](../content/email-templates.md)
