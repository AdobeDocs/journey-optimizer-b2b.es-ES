---
title: Tablero de participación web
description: Analice el comportamiento de los visitantes web con análisis de vistas de página, perspectivas regionales y segmentación industrial para informar su estrategia de contenido.
...
subfeature_v2: id: aa03b4f9-8230-4f55-8705-d4fda6d64f2b
...
![Panel de participación web](./assets/web-engagement-dashboard.png){width="700" zoomable="yes"}

## Filtrado de datos

Haga clic en el icono _Filtro_ ( ![Icono de filtro](../assets/do-not-localize/icon-filter.svg) ) en la parte superior izquierda para filtrar los datos mostrados mediante cualquiera de los atributos siguientes:
...
![Filtrar los datos mostrados por atributos](./assets/web-engagement-dashboard-filters-dialog.png){width="500"}
...
![Tabla de vistas de página principales](./assets/web-engagement-dashboard-top-page-views.png){width="650" zoomable="yes"}
...
![Tabla de vistas de la página principal Ver más elemento emergente: haga clic en Descargar CSV](./assets/web-engagement-dashboard-top-page-views-view-more.png){width="700" zoomable="yes"}
