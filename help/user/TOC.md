...
+ Introducción {#get-started}
   ...
   + Arquitectura simplificada {#simplified-architecture}
      + [Configurar lista de comprobación](./simplified-architecture.md)
   ...
   + [Guía de incorporación del usuario](./start/get-started.md)
