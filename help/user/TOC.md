...
+ administración de recorrido {#journeys}
  ...
  + Nodos del recorrido {#journey-nodes}
    ...
    + [Público de la persona](./journeys/person-audience-nodes.md)
    ...
    + [Rutas divididas de variante (Beta)](./journeys/variant-split-paths-nodes.md)
...
+ Contenido del recorrido {#journey-content}
  ...
  + Canal de correo electrónico {#email-channel}
    ...
    + [Seguimiento de correo electrónico](./content/email-tracking-manage.md)
...
+ Administración {#admin}
  + [Gobernanza y privacidad](./admin/governance.md)
