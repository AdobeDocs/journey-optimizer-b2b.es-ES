...
>[!NOTE]
>
>La acción _[!UICONTROL Valor de datos de cambio de cuenta]_ está obsoleta para la versión 2025.10. _[!UICONTROL Actualizar perfil de cuenta]_ reemplaza esta acción para la [arquitectura simplificada](../simplified-architecture.md).<br/>
>
...
>[!NOTE]
>
>Las acciones _[!UICONTROL Cambiar partición de personas en Marketo Engage]_ y _[!UICONTROL Cambiar puntuación]_ están en desuso para la versión 2025.10 y no están disponibles en la [arquitectura simplificada](../simplified-architecture.md) para Journey Optimizer B2B edition.<br/>
>
...
Utiliza esta acción para enviar un mensaje de WhatsApp. Puedes crear, personalizar y previsualizar mensajes de WhatsApp en el espacio de diseño visual (ver [Creación de WhatsApp](../content/whatsapp-authoring.md).
