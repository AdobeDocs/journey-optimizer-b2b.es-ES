---
title: Panel de perspectivas de rol
description: Obtenga información acerca del panel Perspectivas de funciones, que realiza un seguimiento de la adquisición de funciones y la participación en grupos compradores en Journey Optimizer B2B edition.
...
![Panel de perspectivas de rol](assets/roles-insights-dashboard.png){width="800" zoomable="yes"}
...
![Cuadro de diálogo de filtros para las perspectivas de roles](./assets/roles-insights-filter-dialog.png){width="400"}
...
![Panel de perspectivas de rol - Adquisición de rol con el paso del tiempo](assets/roles-insights-role-aquisition-over-time.png){width="600" zoomable="yes"}
...
![Panel de perspectivas de rol - Participación por gráfico de rol](assets/roles-insights-engagement-by-role.png){width="500" zoomable="yes"}
...
![Panel de perspectivas de rol: participación por rol en el tiempo](assets/roles-insights-engagement-by-role-over-time.png){width="500" zoomable="yes"}
