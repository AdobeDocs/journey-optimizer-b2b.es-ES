...
description: Vea los detalles del grupo de compra con perspectivas impulsadas por IA, administre las funciones de miembro, realice un seguimiento de las puntuaciones de participación y analice los datos de intención en Journey Optimizer B2B edition.
