...
Las herramientas de diseño de [!DNL Journey Optimizer B2B Edition] permiten a los especialistas en marketing crear contenido para **_correos electrónicos_** y **_páginas de aterrizaje_**. Utilice estas herramientas para cumplir con esta directiva, basada en las Directrices de accesibilidad del contenido web (WCAG) 2.1, nivel AA.

En las secciones siguientes se describen las prácticas recomendadas para diseñar contenido accesible con [!DNL Journey Optimizer B2B Edition]. Esta información se centra en diseñar contenido accesible para todos los destinatarios, de modo que las personas con discapacidad puedan leer, comprender e interactuar con los mensajes de correo electrónico y las páginas de aterrizaje.
 

## Garantizar la legibilidad del texto {#text-readability}

Use la ficha **[!UICONTROL Estilos]** del componente **[!UICONTROL Texto]** para asegurarse de que el texto sea legible, por ejemplo, usando un contraste de color adecuado y fuentes simples. Para obtener más información acerca del estilo de los componentes de texto, vea [_Componentes de contenido_](content-components.md#text)

![Pestaña Estilos del componente Texto que muestra las opciones de fuente, tamaño y color](assets/accessible-text-styles.png){width="700" zoomable="yes"}

Para fuentes y texto, siga estas directrices:
...
Para asegurarse de que el contenido es accesible visualmente, siga estas prácticas recomendadas:
...
En [!DNL Journey Optimizer B2B Edition], el tamaño y el espaciado de los diferentes elementos del contenido se pueden refinar aún más mediante los parámetros y atributos de estilo del panel **[!UICONTROL Estilos]** del espacio de diseño visual.
...
![Panel de estilos con configuración de fondo, márgenes, relleno y alineación](assets/accessible-styles.png){width="700" zoomable="yes"}

Las herramientas de diseño visual de [!DNL Journey Optimizer B2B Edition] le permiten obtener una vista previa y optimizar el diseño para diferentes dispositivos y tamaños de pantalla. En cualquier momento, puedes **[!UICONTROL Cambiar a la vista en vivo]** para comprobar cómo puede representarse tu contenido en varios tamaños de dispositivo.

![Opción de vista en vivo que muestra las opciones de escritorio, tableta y vista previa para móviles](assets/accessible-live-view.png){width="700" zoomable="yes"}

>[!CAUTION]
>
>La vista en directo es una previsualización genérica diseñada para comparar el aspecto que podría tener la renderización en varios tamaños de dispositivo. La renderización final puede variar según el cliente de correo electrónico o el explorador web del destinatario.

## Usar texto alternativo para imágenes {#alt-text}

Utilice el componente **[!UICONTROL Image]** para proporcionar texto alternativo para las imágenes. Para obtener más información acerca de la configuración de componentes de imagen, vea [_Componentes de contenido_](content-components.md#image)

![Panel de configuración de componente de imagen con campo de texto alternativo resaltado](assets/accessible-alt-text.png){width="700" zoomable="yes"}

Para obtener texto alternativo efectivo en productos digitales, siga estas directrices:
...
En el espacio de diseño visual, use los componentes [structure](structure-components.md) y [content](content-components.md) relevantes para organizar el contenido de una manera clara, lógica y concisa, accesible para todos. Establezca las opciones en el panel **[!UICONTROL Estilos]** mediante las prácticas recomendadas de herencia estructural.

![Espacio de diseño de correo electrónico que muestra la estructura y los componentes de contenido para los diseños organizados](assets/accessible-components.png){width="700" zoomable="yes"}
...
* Evite utilizar jergas, jergas o palabras regionales que algunas personas podrían no conocer.

Para evaluar la legibilidad del contenido, use la popular [prueba de facilidad de lectura de Flesch](https://support.microsoft.com/en-us/office/get-your-document-s-readability-and-level-statistics-85b4969e-e80a-4777-8dd3-f7fc3c8b3fd2){target="_blank"} en Microsoft Word. Calcula lo fácil que es leer el contenido en una escala de 0 a 100.

## Prueba del contenido {#test}

Para comprobar la accesibilidad del contenido, puede utilizar las funciones de prueba proporcionadas por [!DNL Journey Optimizer B2B Edition]. No están diseñadas específicamente para comprobar si el contenido es totalmente accesible, pero pueden proporcionar un primer nivel de verificación.

* Vista previa del contenido mediante perfiles de prueba.

* Utilice la opción [Procesar correo electrónico](email-test-rendering.md) que aprovecha Litmus para simular los diseños en los principales clientes de correo electrónico (Apple Mail, Gmail, Outlook) y ver si el texto, los colores y las imágenes hacen que el contenido sea accesible.

* Envíe pruebas para probar la renderización del contenido antes de enviarlo a su audiencia real.

![Interfaz de simulación de contenido con opciones de vista previa de perfil de prueba](assets/accessible-simulate.png){width="800" zoomable="yes"}

Para comprobar si el contenido es accesible de forma fiable de forma más coherente, utilice herramientas externas como:
...
![Configuración de diseño para el modo oscuro](assets/email-color-mode-dark-text-settings.png){width="700" zoomable="yes"}

Para el diseño en modo oscuro, utilice imágenes PNG o SVG transparentes y establezca las metaetiquetas y CSS adecuadas. Proporcionar un estilo de reserva accesible si no se admite el modo oscuro. Finalmente, pruebe todo el contenido y los elementos de la interfaz de usuario en los modos claro y oscuro.

Para obtener más información sobre el uso del _modo oscuro_ en el espacio de diseño del correo electrónico, consulte [_Modo oscuro para el contenido del correo electrónico_](./email-dark-mode.md).

## Utilizar atributos específicos para la accesibilidad {#attributes}

Los atributos de HTML ayudan a las tecnologías de asistencia a interpretar la estructura, el idioma y las relaciones del contenido. Las siguientes secciones tratan sobre el idioma y la dirección del texto, las tablas utilizadas para el diseño en comparación con los datos y el texto de los vínculos que los lectores de pantalla anuncian a los usuarios.
...
### Texto para vínculos y botones {#links}

Los lectores de pantalla leen los vínculos usando su texto. Si un vínculo está etiquetado solamente _Haga clic aquí_ o _Más información_, los usuarios de tecnologías de asistencia no conocen el destino. Para garantizar la accesibilidad, necesitan un texto descriptivo que indique claramente el destinatario o la acción.

Utilice las herramientas de diseño para añadir un vínculo al contenido y editar la etiqueta para que sea discernible (visible) y descriptivo (claro sobre el propósito). Evite etiquetas vagas como _aquí_ o _más_.

![Panel de configuración de vínculos que muestra el campo URL y las opciones de etiquetas descriptivas](assets/accessible-link.png){width="700" zoomable="yes"}
