...
![Acceda a la biblioteca de plantillas de páginas de aterrizaje y filtre por nombre](./assets/landing-page-templates-list-search.png){width="700" zoomable="yes"}

Haga clic en el icono _Filtro_ ( ![Icono de filtro](../assets/do-not-localize/icon-filter.svg) ) en la parte superior izquierda para filtrar la lista según las fechas de creación o modificación, y las plantillas que haya creado o modificado.
...
1. En el cuadro de diálogo, escriba un **[!UICONTROL Nombre]** único (obligatorio) y una **[!UICONTROL Descripción]** útil (opcional).
   ...
   ![Escriba las propiedades iniciales de la nueva plantilla de página de aterrizaje](./assets/landing-page-templates-create-dialog.png){width="400"}
...
![Elija cómo desea comenzar con el diseño de la plantilla de la página de aterrizaje](./assets/landing-page-templates-create-design.png){width="800" zoomable="yes"}
...
1. [Agregar estructura y contenido](./landing-page-design.md#structure-content-landing-page) a la plantilla.
...
![Revisar los detalles de la plantilla de la página de aterrizaje](./assets/template-details.png){width="700" zoomable="yes"}
